...
public class Murmurs {
    ...
    public static void main(String[] args) {
        String str1 = "zhang lin xing";
        String str2 = "k";
        long result1 = hash("str1");
        long result2 = hash("str2");
        System.out.println("str1: " +str1 + "  hash: "+ result1);
        System.out.println("str2: " +str2 + "  hash: "+ result2);
    }
}
